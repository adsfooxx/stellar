...
{
    public class CustomerSupportQueryService : ICustomerSupportQueryService
    {
        private readonly string _connectionString;
        private readonly IDbConnection _dbConnection;

        public CustomerSupportQueryService(IConfiguration configuration, IDbConnection dbConnection)
        {
